...
const Page = () => {
    ...
    // Construct API URL
    const apiUrl = `/api/history/clarify-or-challenge?limit=${PAGE_SIZE}&offset=${(queryPage - 1) * PAGE_SIZE}&search=${encodeURIComponent(debouncedSearch)}`;

    // Fetch data using SWR
    const { data, error, isLoading } = useSWR<ClarifyOrChallengeResponse>(apiUrl, fetcher, {
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>Output Text</TableHead>
