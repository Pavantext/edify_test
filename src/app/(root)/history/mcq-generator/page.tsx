...
const Page = () => {
    ...
    const apiUrl = `/api/history/mcq-generator?limit=${PAGE_SIZE}&offset=${(queryPage - 1) * PAGE_SIZE}&search=${encodeURIComponent(debouncedSearch)}`;

    // Fetch data using SWR
    const { data, error, isLoading } = useSWR<McqGeneratorResponse>(apiUrl, fetcher, {
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>Taxonomy Levels</TableHead>
                                <TableHead>Questions Data</TableHead>
                                    ...
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <ResponseModal
                                                ...
                                                content={
                                                    record.taxonomy_levels && record.taxonomy_levels.length > 0
                                                        ? record.taxonomy_levels.join(", ")
                                                        : "None"
                                                }
                                            />
                                        </TableCell>
                                        <TableCell>
                                            <ResponseModal
                                                ...
                                                content={JSON.stringify(record.questions_data, null, 2)}
                                            />
                                        </TableCell>
