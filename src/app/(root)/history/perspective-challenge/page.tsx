...
const Page = () => {
    ...
    const apiUrl = `/api/history/perspective-challenge?limit=${PAGE_SIZE}&offset=${(queryPage - 1) * PAGE_SIZE}&search=${encodeURIComponent(debouncedSearch)}`;

    // Fetch data using SWR
    const { data, error, isLoading } = useSWR<PerspectiveChallengeResponse>(apiUrl, fetcher, {
                                ...
                                history.map((record, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <ResponseModal
                                                title="Analysis"
                                                content={JSON.stringify(record.analysis, null, 2)}
                                            />
                                        </TableCell>
                                        <TableCell>
